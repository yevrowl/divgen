...
Dim Shared makrukcount(8, 8) As Integer
...
Sub chess
    ...
    Loop
    cf = 7
    If new1y = 0 Or new2y = 0 Or new3y = 0 Or new4y = 0 Or new5y = 0 Then GoTo coordinate
...
Sub makruk
    ...
    new1x = 0: new2x = 0: new3x = 0: new4x = 0
    new1y = 0: new2y = 0: new3y = 0: new4y = 0
    count = 0: index = 0
    dc1x = Int(Rnd * 8 + 1)
    dc1y = Int(Rnd * 8 + 1)
    dc2x = Int(Rnd * 8 + 1)
    ...
    x = (dc2x * 40) + 120: y = (dc2y * 40) + 40
    Call queen
    x = (dc3x * 40) + 120: y = (dc4y * 40) + 40
    Call knight
    x = (dc4x * 40) + 120: y = (dc5y * 40) + 40
    Call rook
    ...
    Loop
    cf = 7
    If new1y = 0 Or new2y = 0 Or new3y = 0 Or new4y = 0 Then GoTo coordinate

    If dc1x = new1x And dc1y = Abs(new1y - 9) And dc2x = new2x And dc2y = Abs(new2y - 9) And dc3x = new3x And dc3y = Abs(new3y - 9) And dc4x = new4x And dc4y = Abs(new4y - 9) Then
        Locate 2: Color 2: Print "                       C o n g r a t u l a t i o n   ! ! !                      "
