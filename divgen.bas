...
Sub horsecount
    If dc4x > 2 And dc4x < 8 And dc4y > 2 And dc4y < 9 Then
        Let xiangqicount(dc4x - 2, dc4y - 1) = xiangqicount(dc4x - 2, dc4y - 1) + 1
        Let xiangqicount(dc4x - 1, dc4y - 2) = xiangqicount(dc4x - 1, dc4y - 2) + 1
        Let xiangqicount(dc4x + 1, dc4y - 2) = xiangqicount(dc4x + 1, dc4y - 2) + 1
        Let xiangqicount(dc4x + 2, dc4y - 1) = xiangqicount(dc4x + 2, dc4y - 1) + 1
        Let xiangqicount(dc4x + 2, dc4y + 1) = xiangqicount(dc4x + 2, dc4y + 1) + 1
        Let xiangqicount(dc4x + 1, dc4y + 2) = xiangqicount(dc4x + 1, dc4y + 2) + 1
    ...
    Else
        ...
        If dc4x = 2 And dc4y = 2 Then
            ...
            Let xiangqicount(dc4x - 1, dc4y + 2) = xiangqicount(dc4x - 1, dc4y + 2) + 1
        End If
        If dc4x > 2 And dc4x < 8 And dc4y = 2 Then
            Let xiangqicount(dc4x - 2, dc4y - 1) = xiangqicount(dc4x - 2, dc4y - 1) + 1
            Let xiangqicount(dc4x + 2, dc4y - 1) = xiangqicount(dc4x + 2, dc4y - 1) + 1
            Let xiangqicount(dc4x + 2, dc4y + 1) = xiangqicount(dc4x + 2, dc4y + 1) + 1
            Let xiangqicount(dc4x + 1, dc4y + 2) = xiangqicount(dc4x + 1, dc4y + 2) + 1
